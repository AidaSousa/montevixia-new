...
<div class="row grid mt-8 mb-8">
    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ruta mx-auto" style="margin-top: 120px; margin-bottom: 20px;">

        <div class="block2">
            <div class="block2-pic hov-img0">
                <h2 class="text-center">AXEDREZ</h2>
    ...
    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ruta mx-auto" style="margin-top: 120px; margin-bottom: 20px;">
        ...
        <div class="block2">
            <div class="block2-pic hov-img0">
                <h2 class="text-center">VOLEYBOL</h2>
...
<div class="row grid mt-8 mb-8">
    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ruta mx-auto" style="margin-top: 80px; margin-bottom: 150px;">

        <div class="block2">
            <div class="block2-pic hov-img0">
                <h2 class="text-center">TEATRO</h2>
                <img src="img/pequeruta-3.jpg" alt="IMG">
                <a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                    <button>INSCRIBETE</button>
                </a>
