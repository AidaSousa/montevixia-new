...
@section('content')
  ...
  <div class="container">
    <div class="p-b-66">
      <h3 class="ltext-105 cl5 txt-center respon1">SUBCATEGORÍAS</h3>
    </div>
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                    ...
                                    <a href="/pequeruta">
										<div class="block2-pic hov-img0">
											...
											<a href="route{{ ('forms.rutaPequeForm') }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-link-page">
												Inscríbete
											</a>
										</div>
                                    </a>
