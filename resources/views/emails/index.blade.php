...
<div class="app-title">
        <div class="d-flex">
          ...
          <a href="{{ route('associated.create') }}" class="btn btn-primary ml-3" data-toggle="modal" data-target="#ModalCreate" type="button" onclick="openModal();"><i class="fa fa-plus"></i>Nuevo</a>
        </div>
      </div>
